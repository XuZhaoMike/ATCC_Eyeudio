...
def left_blink_ratio(img, landmarks, left_indices):
    # LEFT_EYE 
    # horizontal line 
...
def right_blink_ratio(img, landmarks, right_indices):
    # Right eyes 
    # horizontal line 
...
with map_face_mesh.FaceMesh(min_detection_confidence =0.5, min_tracking_confidence=0.5) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            leratio = left_blink_ratio(frame, mesh_coords, LEFT_EYE)
            # leratio_max = float(1)
            # control = True
            # while control:
            #     # if leRatio_max is None:
            #     #     leRatio_max = leRatio
            #     # else:
            #     leratio_max = max(leratio_max, leratio)
            # print(leratio_max)
            reratio = right_blink_ratio(frame, mesh_coords, RIGHT_EYE)
